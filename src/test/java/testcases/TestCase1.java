...
public class TestCase1 extends Keywords {
	...
	public void firstTest() throws IOException {
		...
		test=extent.createTest("Test For - https://www.w3.org/standards/badpage");
		test.log(Status.INFO, "Browser launched");
		
		String url="https://www.w3.org/standards/badpage";
		
		//check response code for the page
		System.out.println("App response code - "+getAppResponseCode(url));
		AssertJUnit.assertTrue(getAppResponseCode(url)==404);
		...
		AssertJUnit.assertTrue(getBrokenLinks(url)==0);
