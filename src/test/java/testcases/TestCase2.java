...
public class TestCase2 extends Keywords{
	...
	public void secondTest() throws IOException {
		test=extent.createTest("Test For - https://www.w3.org/standards/webofdevices/multimodal");
		test.log(Status.INFO, "Browser launched");
		String url="https://www.w3.org/standards/webofdevices/multimodal";
